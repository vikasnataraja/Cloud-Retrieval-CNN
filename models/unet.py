...
def Experimental_UNet(input_shape, num_channels, num_classes, final_activation_fn):
  ...
  conv0 = ConvBlock(layer=input_layer, filters=32, kernel_size=(3,3), strides=(1,1), pad_type='same')
  ...
  conv5 = ConvBlock(layer=pool4, filters=1024, kernel_size=(3,3), strides=(1,1), pad_type='same')
  up6 = UpSampleTranspose(layer=conv5, filters=256, kernel_size=(2,2), strides=(1,1), pad_type='same')
  up6 = Dropout(0.5)(up6)
  concat6 = Concatenate(axis=-1)([pool3, up6])

  conv6 = ConvBlock(layer=concat6, filters=512, kernel_size=(3,3), strides=(1,1), pad_type='same')
  up7 = UpSampleTranspose(layer=conv6, filters=128, kernel_size=(2,2), strides=(1,1), pad_type='same')
  up7 = Dropout(0.5)(up7)
  concat7 = Concatenate(axis=-1)([pool2, up7])

  conv7 = ConvBlock(layer=concat7, filters=256, kernel_size=(3,3), strides=(1,1), pad_type='same')
  up8 = UpSampleTranspose(layer=conv7, filters=64, kernel_size=(2,2), strides=(1,1), pad_type='same')
  up8 = Dropout(0.5)(up8)
  concat8 = Concatenate(axis=-1)([pool1, up8])

  conv8 = ConvBlock(layer=concat8, filters=128, kernel_size=(3,3), strides=(1,1), pad_type='same')
  up9 = UpSampleTranspose(layer=conv8, filters=32, kernel_size=(2,2), strides=(1,1), pad_type='same')
  up9 = Dropout(0.5)(up9)
  concat9 = Concatenate(axis=-1)([conv0, up9])
