...
def unet(input_shape, num_channels, num_classes, final_activation_fn):
    ...
    conv6 = conv_block(layer=concat6, filters=512, kernel_size=(3, 3), strides=(1, 1), pad_type='same', decoder=True, dropout=True)
    ...
    conv7 = conv_block(layer=concat7, filters=256, kernel_size=(3, 3), strides=(1, 1), pad_type='same', decoder=True, dropout=True)
    ...
    conv8 = conv_block(layer=concat8, filters=128, kernel_size=(3, 3), strides=(1, 1), pad_type='same', decoder=True, dropout=True)
    ...
    conv9 = conv_block(layer=concat9, filters=64, kernel_size=(3, 3), strides=(1, 1), pad_type='same', decoder=True, dropout=True)
